...
`.factory/runs/<run_id>/trajectory.jsonl`. `bin/factory-trajectory.sh` supports
initialization, event emission with credential-key redaction, human/JSON views,
evaluation exports, summaries, and non-executable replay plans. Overnight,
